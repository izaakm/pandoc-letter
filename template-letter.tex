...
% If the date is not set, it will be automatically included (bc that's how
% latex "letter" documentclass works). If the date is set, the value of \date
% has to be set before calling \opening.
$if(date)$
    \date{$date$}
$endif$
...
$if(closing)$
    ...
    $endif$
    % Remove the white space for the handwritten signature.
    % https://tex.stackexchange.com/a/69303/159246
